...
@section('title', 'Create Role - InApp Inventory Dashboard')
...
<div class="row">
  <div class="col-12">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
      <div>
        <h1 class="fs-3 mb-1">Add Role</h1>
        <p class="mb-0">Define a new system role and assign module permissions</p>
      </div>
      <div>
        ...
        <div class="card-body p-4">
          <div class="row">
            <div class="col-md-6 mb-0">
              ...
              <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. manager, supervisor, auditor" required>
              <div class="form-text">Role names will automatically be stored in lowercase slug format.</div>
              ...
              <div class="card-body p-3">
                @foreach ($permissions as $permission)
                  <div class="form-check mb-2">
                    <input class="form-check-input permission-checkbox perm-group-{{ $groupId }}" type="checkbox" name="permissions[]" id="perm_{{ $permission->id }}" value="{{ $permission->name }}" {{ is_array(old('permissions')) && in_array($permission->name, old('permissions')) ? 'checked' : '' }}>
