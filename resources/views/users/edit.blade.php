...
@section('title', 'Edit User - InApp Inventory Dashboard')
  ...
  <div class="col-12">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
      <div>
        ...
        <p class="mb-0">Update account details, role permissions, or password for {{ $user->name }}</p>
      </div>
      <div>
        ...
        <form id="userEditForm" action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row mb-4">
            <div class="col-12 text-center">
              <div class="position-relative d-inline-block">
                <img id="avatarPreview" src="{{ $user->avatar_url }}" class="avatar avatar-xl rounded-circle border shadow-sm" alt="Preview" style="width: 100px; height: 100px; object-fit: cover;" />
              ...
              <div class="form-text mt-1">Click camera icon to change profile photo</div>
          ...
          <div class="row">
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="tel" class="form-control @error('phone_number') is-invalid @enderror" id="phone_input" value="{{ old('phone_number', $user->phone_number) }}" placeholder="Enter phone number" required>
            ...
            <div class="col-md-4 mb-3">
              ...
              <input type="text" class="form-control @error('username') is-invalid @enderror" id="username" name="username" value="{{ old('username', $user->username) }}" placeholder="Enter username" required>
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Enter new password" minlength="6">
